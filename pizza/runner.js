    ...
    function b(n, q, p, t) {
      if (
        ...
        v.onprogress = function (r) {
          ...
          if (r.loaded) {
            v.Ki
              ? (h.Gj[n].loaded = r.loaded)
              : ((v.Ki = !0),
                h.Gj || (h.Gj = {}),
                (h.Gj[n] = { loaded: r.loaded, total: C }));
            var y = (C = r = 0),
              F;
            for (F in h.Gj) {
              var J = h.Gj[F];
            ...
            h.setStatus &&
              h.setStatus("Downloading data... (" + C + "/" + r + ")");
...
this.activate_clipboard = function () {
  !ua &&
    ...
    ((va = !0),
    navigator.permissions
      .query({ name: "clipboard-read", Zl: !0 })
      .then(function (a) {
      ...
      window.oprt.gameFiles
        ...
        .then((f) => {
          ...
          for (var n = 0; n < f.length; ++n) {
            ...
            0 > v || d[v] != t
              ? l.push(window.oprt.gameFiles.delete(q.fileId, q.version))
              : (g[p] = {
                  name: p,
                  md5: t,
                  fileId: q.fileId,
...
GXMFS = {
  ...
  qk: (a, b) => {
    ...
    return 16384 === (d.mode & 61440)
      ? b(null, { timestamp: d.mtime, mode: d.mode })
      : 32768 === (d.mode & 61440)
      ? ((c.Mi = B.Qk(c)),
        b(null, { timestamp: d.mtime, mode: d.mode, contents: c.Mi }))
...
if (Oa)
  ...
  Na
    ...
    (Ta = (a) => {
        console.warn("tired to set title")
    });
...
function Mb() {
  if (!bb && (Ma || Na)) {
    if ("function" == typeof fetch && !Jb.startsWith("file://"))
      return fetch(Jb, { credentials: "same-origin" })
        .then(function (a) {
...
var H,
  ...
  Sb = {
    ...
    1450017: function (a) {
      function b() {
        ...
        if (
          ...
          (n = "pointerdown"), (q = "pointerup");
        document.body.addEventListener(n, l, { once: !0 });
        document.body.addEventListener(q, l, { once: !0 });
      }
      ...
      d.muted = !1;
      d.src = a;
      const e = { Tl: h.cwrap("video_playback_ended", "", "") },
        f = { Ul: h.cwrap("video_playback_started", "", "") };
      ...
      const g = () => {
        ...
        null == l.Vi
          ? ((l.Vi = document.createElement("canvas")),
            (l.Vi.style.cssText =
        ...
        null != l.Ki &&
          (null != l.Ki.src
            ? l.Ki.requestVideoFrameCallback(g)
    ...
    1454028: function () {
      ...
      return null != a.Ki
        ? a.Ki.ended
          ...
          : a.Ki.paused
          ? 3
          : a.Ki.readyState < a.Ki.HAVE_CURRENT_DATA
          ? 1
          : 2
        : 0;
    },
    ...
    1454840: function (a, b, c, d) {
      ...
      null == e.ej &&
        ((e.ej = document.createElement("canvas")),
        (e.ej.style.cssText =
          "position:fixed; top:1px; left:1px; width:1px; height:1px"),
        (e.ej.width = a),
        (e.ej.height = b),
    ...
    1457336: function (a) {
      ...
      if (b.Qi && ("recording" == b.Qi.state || "paused" == b.Qi.state)) {
        ...
        b.Qi.onstop = function () {
          var d = new Blob(b.oj, { type: "video/webm" });
          b.oj = [];
          clearInterval(b.gk);
          b.gk = null;
          const e = {
    ...
    1459531: function (a, b, c, d) {
      ...
      if (void 0 != window.oprt) {
        ...
        0 != (a & 5) && void 0 != l && "function" == typeof l
          ? (l(), console.log("Locking to Landscape"), (e = 0))
          : 0 != (a & 10) &&
            void 0 != g &&
            "function" == typeof g &&
      ...
      navigator.mediaDevices &&
        ...
        navigator.mediaDevices
          ...
          .then((b) => {
            ...
            ha = b;
            ia = new AudioContext({ sampleRate: a });
            ia.audioWorklet
              ...
              .then(() => {
                ...
                ea = new MediaStreamAudioSourceNode(ia, { mediaStream: b });
                const d = c(b);
                1 < d
                  ? ((ka = new ChannelMergerNode(ia, { numberOfInputs: d })),
                    ea.connect(ka),
                    ka.connect(ja))
                  : ea.connect(ja);
                ia.resume();
    ...
    1467612: function (a, b) {
      this.chrome &&
        this.chrome.runtime &&
        chrome.runtime.sendMessage(x(a), { command: x(b) });
    },
    1467749: function (a, b, c, d, e) {
      ...
      const g = { gl: h.cwrap("YYSum", "", ["number", "number"]) };
      this.chrome &&
        this.chrome.runtime &&
        ((e = A.subarray(e, e + 20)),
        (a = x(a)),
        chrome.runtime.sendMessage(
          x(c),
          { command: x(d), randomString: a, hash: e },
          f
        ));
    },
    1468309: function () {
    ...
    1469678: function () {
      return ("undefined" !== typeof navigator.mediaDevices &&
    ...
    1469912: function (a) {
      ...
      b.Ri ||
        ("undefined" !== typeof AudioContext
          ? (b.Ri = new AudioContext())
          : "undefined" !== typeof webkitAudioContext &&
            (b.Ri = new webkitAudioContext()),
        b.Ri && Qb(b.Ri));
    ...
    1470473: function (a, b, c, d) {
      ...
      function f(l) {
        void 0 !== g.capture.Nj &&
          (clearTimeout(g.capture.Nj), (g.capture.Nj = void 0));
    ...
    1472125: function (a, b, c, d) {
      ...
      e.audio.Xi.onaudioprocess = function (f) {
        void 0 !== e &&
          void 0 !== e.audio &&
          ((e.audio.Mk = f.outputBuffer), Rb("vi", c, [d]));
      };
      e.audio.Xi.connect(e.Ri.destination);
    },
    1472535: function (a, b) {
      for (
        var c = h.SDL2, d = c.capture.jk.numberOfChannels, e = 0;
        e < d;
        ++e
      ) {
        ...
        if (1 == d) for (var g = 0; g < b; ++g) db(a + 4 * g, f[g], "float");
        else for (g = 0; g < b; ++g) db(a + 4 * (g * d + e), f[g], "float");
      }
    },
    ...
    1473620: function (a) {
      ...
      if (a) {
        ...
        void 0 !== b.capture.Xi &&
          ((b.capture.Xi.onaudioprocess = function () {}),
          b.capture.Xi.disconnect(),
          (b.capture.Xi = void 0));
        void 0 !== b.capture.Uj &&
          (b.capture.Uj.disconnect(), (b.capture.Uj = void 0));
        void 0 !== b.capture.$j && (b.capture.$j = void 0);
        b.capture = void 0;
      } else
        void 0 != b.audio.Xi &&
          (b.audio.Xi.disconnect(), (b.audio.Xi = void 0)),
          (b.audio = void 0);
      void 0 !== b.Ri &&
        void 0 === b.audio &&
        void 0 === b.capture &&
        (b.Ri.close(), (b.Ri = void 0));
    },
    1474792: function (a, b, c) {
      h.SDL2 || (h.SDL2 = {});
      var d = h.SDL2;
      d.ll !== h.canvas &&
        ((d.fj = h.createContext(h.canvas, !1, !0)), (d.ll = h.canvas));
  ...
  B = {
    ...
    createNode: function (a, b, c, d) {
      ...
      B.hj ||
        (B.hj = {
          ...
          link: {
            node: { gj: B.Li.gj, Yi: B.Li.Yi, readlink: B.Li.readlink },
            stream: {},
          },
          Lk: { node: { gj: B.Li.gj, Yi: B.Li.Yi }, stream: lc },
        });
      c = mc(a, b, c, d);
      16384 === (c.mode & 61440)
        ? ((c.Li = B.hj.dir.node), (c.Ni = B.hj.dir.stream), (c.Mi = {}))
        : 32768 === (c.mode & 61440)
        ? ((c.Li = B.hj.file.node),
          ...
          (c.Mi = null))
        : 40960 === (c.mode & 61440)
        ? ((c.Li = B.hj.link.node), (c.Ni = B.hj.link.stream))
        : 8192 === (c.mode & 61440) &&
          ((c.Li = B.hj.Lk.node), (c.Ni = B.hj.Lk.stream));
    ...
    Li: {
      ...
      rename: function (a, b, c) {
        if (16384 === (a.mode & 61440)) {
          ...
          if (d) for (var e in d.Mi) throw new Q(55);
        }
    ...
    Ni: {
      ...
      Bj: function (a, b, c) {
        1 === c
          ? (b += a.position)
          : 2 === c && 32768 === (a.node.mode & 61440) && (b += a.node.Oi);
...
var O = {
    ...
    wl: (a, b) => {
      ...
      d.onupgradeneeded = (e) => {
        ...
        var g;
        f.objectStoreNames.contains(O.tj)
          ? (g = e.objectStore(O.tj))
          : (g = f.createObjectStore(O.tj));
    ...
    nk: (a, b) => {
      ...
      O.wl(a.rj, (d, e) => {
        ...
        try {
          ...
          f.objectStore(O.tj).index("timestamp").openKeyCursor().onsuccess = (
            g
          ) => {
            g = g.target.result;
    ...
    uk: (a, b, c) => {
      ...
      Object.keys(a.entries).forEach(function (p) {
        var t = a.entries[p],
          v = b.entries[p];
        (v && t.timestamp.getTime() == v.timestamp.getTime()) ||
          (f.push(p), e++);
      });
      var g = [];
  ...
  yc = (a) => {
    for (var b; ; ) {
      if (a === a.parent)
        return (
          (a = a.Si.rj), b ? ("/" !== a[a.length - 1] ? a + "/" + b : a + b) : a
        );
      b = b ? a.name + "/" + b : a.name;
      a = a.parent;
    }
  ...
  Ec = { r: 0, "r+": 2, w: 577, "w+": 578, a: 1089, "a+": 1090 },
  Fc = (a) => {
    var b = ["r", "w", "rw"][a & 3];
    a & 512 && (b += "w");
    return b;
  ...
  Pc = (a) => Ba(a, !0),
  Ea = (a, b) => {
    a = "string" == typeof a ? D(a, { zj: !0 }).node : a;
    if (!a.Li.Yi) throw new Q(63);
    a.Li.Yi(a, { mode: (b & 4095) | (a.mode & -4096), timestamp: Date.now() });
  },
  Fa = (a, b, c) => {
    a = D(a, { zj: !0 }).node;
    a.Li.Yi(a, { timestamp: Math.max(b, c) });
  },
  Rc = (a, b, c) => {
    if ("" === a) throw new Q(44);
    if ("string" == typeof b) {
    ...
    if (
      ...
      (c = e
        ? 40960 === (e.mode & 61440)
          ? 32
          : 16384 === (e.mode & 61440) && ("r" !== Fc(b) || b & 512)
          ? 31
          : Cc(e, Fc(b))
        : 44)
    )
    ...
    if (b & 512) {
      c = e;
      c = "string" == typeof c ? D(c, { zj: !0 }).node : c;
      ...
      c.Li.Yi(c, { size: 0, timestamp: Date.now() });
    }
    b &= -131713;
    e = Kc({
      node: e,
  ...
  $c = (a, b, c, d, e, f) => {
    var g = b;
    a &&
      ((a = "string" == typeof a ? a : yc(a)), (g = b ? za(a + "/" + b) : a));
    a = Xc(d, e);
  ...
  cd = (a, b, c, d, e) => {
    ...
    f.prototype.Ik = function () {
      ...
      var t = Number(p.getResponseHeader("Content-length")),
        v,
        r = (v = p.getResponseHeader("Accept-Ranges")) && "bytes" === v;
      ...
      y.Ki((F) => {
        ...
        if ("undefined" == typeof y.oj[F]) {
          ...
          if (J > M)
            throw Error(
              "invalid range (" + J + ", " + M + ") or no bytes requested!"
            );
          if (M > t - 1)
    ...
    q.read = (p, t, v, r, C) => {
      ...
      if (p.slice) for (var y = 0; y < r; y++) t[v + y] = p[C + y];
      else for (y = 0; y < r; y++) t[v + y] = p.get(C + y);
      return r;
    };
    n.Ni = q;
    return n;
    ...
    if (!jb)
      if (0 < Ad.length) {
        ...
        if (Bd) {
          ...
          Bd = d.bm ? f : (8 * e + (f + 0.5)) / 9;
        }
        Xa(
          'main loop blocker "' + d.name + '" took ' + (Date.now() - c) + " ms"
        );
        h.setStatus &&
          ((c = h.statusMessage || "Please wait..."),
          (d = Bd),
          (e = Cd.dm),
          d
            ? d < e
        ...
        if (((Dd = (Dd + 1) | 0), 1 == pd && 1 < qd && 0 != Dd % qd)) td();
          ...
          jb ||
            ...
            (Fd(a), h.postMainLoop && h.postMainLoop());
          b < zd ||
            ("object" == typeof SDL &&
              SDL.audio &&
              SDL.audio.Hl &&
  ...
  if (!Ld) {
    ...
    h.preloadPlugins.push({
      ...
      handle: function (c, d, e, f) {
        ...
        if (Md)
          try {
            (g = new Blob([c], { type: Pd(d) })),
              g.size !== c.length &&
                (g = new Blob([new Uint8Array(c).buffer], { type: Pd(d) }));
          } catch (q) {
            Ya(
    ...
    h.preloadPlugins.push({
      canHandle: function (c) {
        return !h.jm && c.substr(-4) in { ".ogg": 1, ".wav": 1, ".mp3": 1 };
      },
      handle: function (c, d, e, f) {
        function g() {
          n || ((n = !0), e && e(c));
  ...
  function c() {
    ...
    (document.fullscreenElement ||
      ...
      ? ((d.exitFullscreen = Zd),
        ...
        Xd
          ? ("undefined" != typeof SDL &&
              (G[SDL.screen >> 2] = N[SDL.screen >> 2] | 8388608),
            $d(h.canvas),
            ae())
          : $d(d))
      : (f.parentNode.insertBefore(d, f),
        ...
        Xd
          ? ("undefined" != typeof SDL &&
              (G[SDL.screen >> 2] = N[SDL.screen >> 2] & -8388609),
            $d(h.canvas),
            ae())
          : $d(d));
...
var Ld,
  ...
  fe = 0,
  ge = 0,
  he = { alpha: !1, depth: !1, stencil: !1, antialias: !1 },
  ie = {},
  je;
function ke(a) {
...
function Je(a, b) {
  var c = De(Td),
    d = { zl: c, attributes: b, version: b.Tj, dj: a };
...
function Me(a, b, c) {
  ...
  var d;
  for (c >>= 2; (d = A[b++]); )
    (d = 105 > d) && c & 1 && c++, Le.push(d ? gb[c++ >> 1] : G[c]), ++c;
...
function zf(a) {
  return 0 > rf.indexOf(a) ? a.getBoundingClientRect() : { left: 0, top: 0 };
}
function Af(a, b) {
  if (0 != b.yk || 0 != b.ik) {
    xf(a);
    ...
    g = g[1];
    3 == b.yk
      ? (yf(a, (d - e) / 2, (c - f) / 2), (c = f), (d = e))
      : 2 == b.yk &&
        (c * g < l * d
          ? ((f = (g * c) / l), yf(a, (d - f) / 2, 0), (d = f))
          : ((f = (l * d) / g), yf(a, 0, (c - f) / 2), (c = f)));
...
function Jf(a, b, c) {
  if (b) {
    ...
    if (void 0 === d)
      switch (((e = T.getParameter(a)), typeof e)) {
        case "number":
          d = e;
          break;
        case "boolean":
...
function Nf(a) {
  ...
  if (!b)
    for (
      a.Fj = b = {}, a.dl = {}, d = 0;
      d < T.getProgramParameter(a, 35718);
      ++d
    ) {
...
function Y(a) {
  ...
  if (b) {
    ...
    "number" == typeof c &&
      (b.Fj[a] = c =
        T.getUniformLocation(b, b.dl[a] + (0 < c ? "[" + c + "]" : "")));
    return c;
  }
  X(1282);
}
  ...
  Ze({
    ...
    aj: function (g) {
      for (var l, n = {}, q = g.touches, p = 0; p < q.length; ++p)
        (l = q[p]), (l.Uk = l.al = 0), (n[l.identifier] = l);
      for (p = 0; p < g.changedTouches.length; ++p)
        (l = g.changedTouches[p]), (l.Uk = 1), (n[l.identifier] = l);
...
function lg(a, b, c, d, e) {
  function f(L) {
    var fa = 0,
      R = 0;
    L &&
      ((R = z.response ? z.response.byteLength : 0),
      (fa = m(R)),
...
function Eg(a, b, c, d) {
  ...
  function g(r, C) {
    ...
    var F;
    0 === (F = y(r.getFullYear() - C.getFullYear())) &&
      0 === (F = y(r.getMonth() - C.getMonth())) &&
      (F = y(r.getDate() - C.getDate()));
    return F;
  }
  function l(r) {
    switch (r.getDay()) {
  ...
  q = {
    ...
    "%z": function (r) {
      ...
      r = Math.abs(r) / 60;
      return (
        (C ? "+" : "-") + String("0000" + ((r / 60) * 100 + (r % 60))).slice(-4)
      );
    },
    "%Z": function (r) {
      return r.Ql;
...
var Xg = {
  ...
  Fb: function (a, b, c) {
    try {
      ...
      a = 0;
      for (
        var e = Tc(d, 0, 1), f = Math.floor(e / 280);
        f < d.Aj.length && a + 280 <= c;
        ...
        if ("." === g) {
          var l = d.node.id;
          var n = 4;
        } else if (".." === g) (l = D(d.path, { parent: !0 }).node.id), (n = 4);
        else {
          var q = oc(d.node, g);
          l = q.id;
          n =
  ...
  Qb: function (a) {
    ...
    G[(a + 28) >> 2] =
      ((b.getTime() - Date.UTC(b.getUTCFullYear(), 0, 1, 0, 0, 0, 0)) / 864e5) |
      0;
    return (b.getTime() / 1e3) | 0;
  },
  Rb: nd,
  ...
  Bh: function (a, b, c) {
    if (62e3 == a)
      return (
        b && (G[b >> 2] = 1), c && (G[c >> 2] = 4), (de = !0), (U = 12288), 1
      );
    U = 12296;
    return 0;
  },
  vh: function (a, b, c, d) {
    if (62e3 != a) return (U = 12296), 0;
    if (0 != d && 62004 != d) return (U = 12294), 0;
  ...
  Oh: function (a, b, c, d, e, f, g, l) {
    ...
    p.onload = function () {
      if (
        ...
        (0 === p.status && "http" != q.substr(0, 4).toLowerCase())
      ) {
  ...
  Bg: function (a, b, c, d) {
    2 <= S.version
      ? c
        ? T.bufferData(a, A, d, c, b)
        : T.bufferData(a, b, d)
      : T.bufferData(a, c ? A.subarray(c, c + b) : b, d);
  },
  Ag: function (a, b, c, d) {
    2 <= S.version
      ? T.bufferSubData(a, b, A, d, c)
      : T.bufferSubData(a, b, A.subarray(d, d + c));
  },
  zg: function (a) {
  ...
  sg: function (a, b, c, d, e, f, g, l) {
    2 <= S.version
      ? T.Ti
        ? T.compressedTexImage2D(a, b, c, d, e, f, g, l)
        : T.compressedTexImage2D(a, b, c, d, e, f, A, l, g)
      : T.compressedTexImage2D(
          ...
          e,
          f,
          l ? A.subarray(l, l + g) : null
        );
  },
  Td: function (a, b, c, d, e, f, g, l, n) {
    T.Ti
      ? T.compressedTexImage3D(a, b, c, d, e, f, g, l, n)
      : T.compressedTexImage3D(a, b, c, d, e, f, g, A, n, l);
  },
  rg: function (a, b, c, d, e, f, g, l, n) {
    2 <= S.version
      ? T.Ti
        ? T.compressedTexSubImage2D(a, b, c, d, e, f, g, l, n)
        : T.compressedTexSubImage2D(a, b, c, d, e, f, g, A, n, l)
      : T.compressedTexSubImage2D(
          ...
          f,
          g,
          n ? A.subarray(n, n + l) : null
        );
  },
  Sd: function (a, b, c, d, e, f, g, l, n, q, p) {
    T.Ti
      ? T.compressedTexSubImage3D(a, b, c, d, e, f, g, l, n, q, p)
      : T.compressedTexSubImage3D(a, b, c, d, e, f, g, l, n, A, p, q);
  },
  ...
  xc: function (a, b) {
    for (var c = 0; c < a; c++) {
      var d = G[(b + 4 * c) >> 2],
        e = ve[d];
      e && (T.deleteSampler(e), (e.name = 0), (ve[d] = null));
    }
  },
  hg: function (a) {
    if (a) {
  ...
  Hc: function (a, b) {
    return (a = T.fenceSync(a, b))
      ? ((b = De(xe)), (a.name = b), (xe[b] = a), b)
      : 0;
  },
  Wf: function () {
    T.finish();
      ...
      d
        ? d.Fk & 16
          ? 0 > b || 0 > c || b + c > d.length
            ? (X(1281), k("invalid range in glFlushMappedBufferRange"))
            : T.bufferSubData(a, d.offset, A.subarray(d.Cj + b, d.Cj + b + c))
          : (X(1282),
            k(
  ...
  Mc: function (a, b, c, d) {
    if (d)
      if (((a = V[a]), 35393 == c))
        (c = T.getActiveUniformBlockName(a, b)), (G[d >> 2] = c.length + 1);
      else {
        if (((a = T.getActiveUniformBlockParameter(a, b, c)), null !== a))
          if (35395 == c)
  ...
  Xg: function (a, b, c) {
    if (c) {
      ...
      b =
        2 > S.version
          ? T.Wi.getQueryObjectEXT(a, b)
          : T.getQueryParameter(a, b);
      var d;
  ...
  yf: function (a, b, c) {
    c
      ? 35716 == b
        ? ((a = T.getShaderInfoLog(W[a])),
          null === a && (a = "(unknown error)"),
          (G[c >> 2] = a ? a.length + 1 : 0))
        : 35720 == b
        ? ((a = T.getShaderSource(W[a])), (G[c >> 2] = a ? a.length + 1 : 0))
        : (G[c >> 2] = T.getShaderParameter(W[a], b))
      : X(1281);
  },
  uf: function (a) {
    var b = ze[a];
  ...
  Bc: function (a, b, c, d, e) {
    0 > c
      ? X(1281)
      : e
      ? ((a = T.getSyncParameter(xe[a], b)),
        null !== a && ((G[e >> 2] = a), d && (G[d >> 2] = 1)))
      : X(1281);
  },
  tf: function (a, b, c) {
  ...
  of: function (a, b) {
    ...
    if ((a = V[a])) {
      ...
      if (
        (e = a.ek[e]) &&
        d < e[0] &&
        ((d += e[1]), (c[d] = c[d] || T.getUniformLocation(a, b)))
      )
        return d;
    } else X(1281);
    return -1;
  ...
  lf: function (a, b, c) {
    c
      ? (S.bj[a].enabled &&
        ...
        (G[c >> 2] = T.getVertexAttribOffset(a, b)))
      : X(1281);
  },
  nf: function (a, b, c) {
    Pf(a, b, c, 2);
  ...
  yd: function (a, b, c, d) {
    ...
    var e = m(c);
    if (!e) return 0;
    pe[Ef(a)] = { offset: b, length: c, Cj: e, Fk: d };
    return e;
  },
  jc: function () {
  ...
  Kd: function (a) {
    if (!Ff(a)) return X(1280), k("GL_INVALID_ENUM in glUnmapBuffer"), 0;
    var b = Ef(a),
      c = pe[b];
    ...
    c.Fk & 16 ||
      (2 <= S.version
        ? T.bufferSubData(a, c.offset, A, c.Cj, c.length)
        : T.bufferSubData(a, c.offset, A.subarray(c.Cj, c.Cj + c.length)));
    ca(c.Cj);
    return 1;
  },
  me: function (a) {
  ...
  kd: function (a, b, c, d, e) {
    var f = S.bj[a];
    T.kj
      ? ((f.wj = !1), T.vertexAttribIPointer(a, b, c, d, e))
      : ((f.size = b),
        (f.type = c),
        (f.Xj = !1),
        (f.Oj = d),
  ...
  ce: function (a, b, c, d, e, f) {
    var g = S.bj[a];
    T.kj
      ? ((g.wj = !1), T.vertexAttribPointer(a, b, c, !!d, e, f))
      : ((g.size = b),
        (g.type = c),
        (g.Xj = d),
        (g.Oj = e),
  ...
  ih: function (a, b, c, d, e) {
    ...
    if ("EM_IDB_STORE" === g)
      (g = N[(f + 84) >> 2]), mg(a, A.slice(g, g + N[(f + 88) >> 2]), F, M);
  ...
  rf: function (a, b, c, d) {
    function e(t, v, r, C, y, F) {
      ...
      if (10 === t)
        a: {
          ...
          for (z = 0; 8 > z; z++)
            0 === y[z] && (1 < z - fa && (yb = 0), (fa = z), yb++),
              yb > L && ((L = yb), (R = z - L + 1));
          for (z = 0; 8 > z; z++)
            1 < L && 0 === y[z] && z >= R && z < R + L
              ? z === R && ((M += ":"), 0 === R && (M += ":"))
              : ((M += Number(Kg(y[z] & 65535)).toString(16)),
                (M += 7 > z ? ":" : ""));
        }
      else M = Ag(y);
      y = M;
    ...
    if (b && ((b = x(b)), (g = parseInt(b, 10)), isNaN(g)))
      return l & 1024 ? -2 : -8;
    if (!a)
      return (
        0 === n && (n = 2),
  ...
  function b() {
    if (!Zg && ((Zg = !0), (h.calledRun = !0), !jb)) {
      h.noFSInit ||
        ...
        h.stdout
          ? ad("/dev", "stdout", null, h.stdout)
          : Oc("/dev/tty", "/dev/stdout"),
        h.stderr
          ? ad("/dev", "stderr", null, h.stderr)
          : Oc("/dev/tty1", "/dev/stderr"),
        Rc("/dev/stdin", 0),
        Rc("/dev/stdout", 1),
        Rc("/dev/stderr", 1));
      vc = !1;
      ...
      if (h.postRun)
        for (
          ...
          (c = h.postRun.shift()), Bb.unshift(c);
      Ub(Bb);
    }
  }
  a = a || Ja;
...
"undefined" != typeof window &&
  ((api_error_callback = h.cwrap("api_error_callback", null, [
    "number",
    "string",
  ])),
  (create_game_callback = h.cwrap("create_game_callback", null, [
    "string",
    "string",
    "string",
  ])),
        ...
        ? n.json().then((q) => {
            ...
            g
              ? ((p =
                  ...
                  "?game=debug&roomUrl=" +
                  t),
                set_local_share_url(p))
              : post_share_url(p);
            create_game_callback(q, p, t);
          })
        : n.json().then((q) => {
            if (window.parent) {
              var p = { type: "api_error" };
  ...
  (gxc_receive_chat_message = (a, b, c) => {
    window.parent.postMessage(
      { type: "receive_chat_message", content: a, src: b, ql: c },
      "*"
    );
  }),
  (gxc_report_status = (a) => {
